...
export const META_DESCRIPTION_LABEL = "Meta description";
...
export const IMG_MAX_SIZE = "The image must be a maximum of {size}MB.";
export const IMG_FORMAT = "The image format must be (png, jpg or jpeg).";
export const ICON_MAX_SIZE = "The icon must be a maximum of {size}MB.";
...
export const ALT_USER_IMG = "User";
...
export const CHOSE_CATEGORY_TEXT = "Personalize your discovery experience! Select a category and explore related listings, making the discovery experience easier and more efficient.";
export const FIND_LOCATIONS = "Find by locations";
export const FIND_LOCATIONS_TEXT = "Explore listings in specific locations, browse relevant listings, and connect with what’s happening in your city.";
export const MOST_WANTED = "Most wanted";
export const MOST_WANTED_TEXT = "Discover what’s trending now! Explore our selection of the most wanted and popular items. From products to services, these picks are our community’s favorites.";
...
export const CATEGORY_NOT_FOUND = "No categories found, check applied filters.";
...
export const CATEGORY_INACTIVE = "Inactive";
export const SEARCHING_CATEGORIES = "Searching categories...";
export const FILTER = "Filter";
export const CLEAN = "Clean";
export const DROP_FILE_HERE = "Drop file here or";
